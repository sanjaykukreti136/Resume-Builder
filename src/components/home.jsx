        ...
        <div  >
            ...
            <div className="templates" id={blur == true ? "blur" : ""}  >
                ...
                <div className="temp-box" onMouseOut={() => {
                    ...
                    <img src="http://localhost:3000/B.png" ></img>
                ...
                <div className="temp-box" onMouseOut={() => {
                    ...
                    <img src="http://localhost:3000/C.png" ></img>
                    <p class="temp-box-p" >BASIC</p>
            ...
            <div className="port">
                ...
                <div className="port-box" onClick={() => {
                    dispatch(templateSelect("AA"));
                    history.push("/personal");
                }} >

                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTc7jD4CzTZ64jPSvx0rXc48_bSJvgRITH6Lw&usqp=CAU" ></img>
                </div>
